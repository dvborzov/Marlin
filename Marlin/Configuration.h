...
#define STRING_CONFIG_H_AUTHOR "(SWO)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 141.72
  #define DEFAULT_bedKi  27.19
  #define DEFAULT_bedKd 492.40
...
#define TOUCH_SCREEN
  ...
  //#define KP3s_screen_rotate //Enable for rotete screen 180 degree
    ...
    #define TOUCH_CALIBRATION_X  -11924
    #define TOUCH_CALIBRATION_Y    8754
    #define TOUCH_OFFSET_X          350
    #define TOUCH_OFFSET_Y          -11
  #else
    /* Normal rotate screen colibration*/
    #define TOUCH_CALIBRATION_X  12021
